	...
	<tr><td align="center">
		<table width="90%" border="0" cellspacing="0" cellpadding="0" >
			...
			<tr><td align="center"  >
				<div style="line-height: 24px;">
					<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
						<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
							Hai <b>Admin</b>,
							Berikut terlampir member yang sudah melakukan konfirmasi pembayaran untuk event yang dia pesan.
							<br><br>
							Harap melakukan <b>pengecekan</b> bukti pembayaran melalui nomor unik pada<br>harga total yang telah diberikan dari sistem. 
							Apabila sudah selesai melakukan pengecekan, harap melakukan konfirmasi di halaman admin.
						</span></font>
					</div>
			    ...
			    <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
				<table width="90%" border="0" cellspacing="0" cellpadding="0" style="font-size: 14px;color:#57697e;">
					<tr><td colspan="2">Berikut adalah rincian konfirmasi: <br/><br/></td></tr>
					...
					<tr style="height:30px">
						<td>Nama:</td>
						@if(Auth::check())
						<td><b>{{ $booking->member->name }}</b></td>
						@else
						<td><b>{{ $booking->guest->name }}</b></td>
						@endif
					</tr>
					<tr style="height:30px">
						<td>Sub Total:</td>
						<td><b>{{ number_format($booking->bookDetail->subtotal) }}</b></td>
					</tr>
					<tr style="height:30px">
						<td>Unique Code:</td>
						<td><b>{{ $booking->unique_number }}</b></td>
					</tr>
					<tr style="height:30px">
						<td>Total :</td>
						<td><b>{{ number_format($booking->total,0) }}</b></td>
					</tr>
				</table>
				</font>
			</td></tr>
